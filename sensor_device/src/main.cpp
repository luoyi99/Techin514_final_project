...
// void isValidJump(sensors_event_t a) {
...
//       // Serial.println("Signal from buffer");
//       // Serial.println(err);
//       if (err != 0) {
...
//           if (result.classification[ix].label == "standard")
//           {
//             Serial.println("standard");
//             valid_jumps++;
//           } else if (result.classification[ix].label == "non-standard")
//           {
...
//       processSensorData(a, 7);
//       isValidJump(a);
    

//       message = String(total_jumps) + "," + String(valid_jumps) +"," + String(performance);
...
//         unsigned long currentMillis = millis();
//         if (currentMillis - previousMillis >= interval) {
//         pCharacteristic->setValue(String(currentMillis).c_str());
//         pCharacteristic->notify();
//         Serial.print("Notify value: ");
//         Serial.println(String(currentMillis).c_str());
//         }
//     }
//     // disconnecting
//     if (!deviceConnected && oldDeviceConnected) {
...
void loop() {
  ...
  if (exerciseSessionStarted){
    // if(mpu.getMotionInterruptStatus()) {
      ...
      // message = String(total_jumps) + "," + String(currentTime - startTime) + "," + exerciseSessionStarted;
      // Serial.println(message);
      // Serial.println(message);
